...
export default function BuyFromTokenModal() {
    const theme = useTheme();
    const fullScreen = useMediaQuery(theme.breakpoints.down('md'));
    const { modalIsOpened, closeBuyFromTokenModal } = useBuyFromToken();
    ...
    return (
        <Dialog
            ...
            open={modalIsOpened}
            onClose={closeBuyFromTokenModal}
            aria-labelledby="responsive-dialog-title"
            fullWidth={true}
            maxWidth="sm"
        >
            <DialogTitle id="responsive-dialog-title" onClose={closeBuyFromTokenModal}>
